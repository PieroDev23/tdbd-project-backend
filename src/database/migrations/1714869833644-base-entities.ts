...
export class BaseEntities1714869833644 implements MigrationInterface {
    name = 'BaseEntities1714869833644'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`agents\` (\`agent_id\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, \`agent_role\` enum ('DUELIST', 'INTIATORS', 'SENTINELS', 'CONTROLLERS') NOT NULL, \`primary_skill\` varchar(255) NOT NULL, \`secondary_skill\` varchar(255) NOT NULL, \`tertiary_skill\` varchar(255) NOT NULL, \`ultimate\` varchar(255) NOT NULL, \`created_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updated_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (\`agent_id\`)) ENGINE=InnoDB`);
